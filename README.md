...
> Here is [the working version](https://mate-academy.github.io/react_counnpm startter/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Mantserov.github.io/react_counter-js/) and add it to PR description.
