...
## Instructions
- Install Prettier Extesion and use this [VSCode settings](https://DianaKadimbekova.github.io/fe-program/tools/vscode/settings.json) to enable format on save.
