[DEMO LINK](https://artemvlasiuk.github.io/react_counter-js/)
# React counter
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artemvlasiuk.github.io/react_counter-js/) and add it to PR description.
